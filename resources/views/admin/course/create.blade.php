                ...
                <li><a href="">Add Course</a></li>
                      ...
                      <div class="panel-body">                   
                         <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="name" class="form-control"  data-required="true" placeholder="Course Name" required>   
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <textarea class="summernote" name="eligibility" class="form-control" required></textarea> 
<!--                             <input type="text" name="yoe" class="form-control"  data-required="true" placeholder="Years Of Experience" data-parsley-type="digits" maxlength="2" required>    -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="duration" class="form-control"  data-required="true" placeholder="Duration" required> 
                          ...
                          <div class="col-sm-9">
                            ...
                            <!-- Text input-->
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-5">
                                                  <input id="action_id" name="session_name[]" type="text" placeholder="" class="form-control input-md" required>
                                                  </div>
                                                  <label class="col-md-4 control-label" for="action_id">Topic</label>  
                                                  <div class="col-md-5">
                                                  <input id="action_id" name="topic[]" type="text" placeholder="" class="form-control input-md" required>
                                                  </div>
                                                </div>
                                                <!-- Text input-->
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-5">
                                                  <textarea class="" cols="100" name="description[]" class="form-control" required></textarea> 
